...
final class UIViewLeadingSnapToTests: XCTestCase {
    ...
    func test_leading_snapTo_anchor() {
    ...
    func test_leading_snapTo_safeArea() {
    ...
    func test_leading_snapTo_margin() {
    ...
    func test_leading_snapTo_padding() {
